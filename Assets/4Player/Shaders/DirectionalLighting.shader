...
Shader "DirectionalLighting"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_output_58_0 = ( ( _gradientColor * 0.5 ) * clamp( ( pow( ( dot( _gradientDirection , vertexPos ) - _gradientStart ) , 0.5 ) * ( 1.0 / _gradientLength ) ) , 0.0 , 1.0 ) );
			o.Albedo = ( saturate( 	max( temp_output_37_0, temp_output_58_0 ) )).rgb;
			o.Emission = ( saturate( 	max( ( temp_output_37_0 * _shine ), temp_output_58_0 ) )).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.Vector3Node;76;148.904,-169.2643;Float;False;Property;_gradientDirection;gradientDirection;10;0;0,1,0;FLOAT3;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;51;187.7064,314.4359;Float;False;Property;_gradientStart;gradientStart;7;0;2;0;0;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;66;198.5041,457.9359;Float;False;Constant;_Float0;Float 0;10;0;1;0;0;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;55;179.8067,535.6363;Float;False;Property;_gradientLength;gradientLength;8;0;0.5;0;0;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;34;808.1861,1574.446;Float;False;Property;_Color_z2;Color_z2;5;0;0.3740492,0.625,0.1332721,1;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.PowerNode;71;497.7039,302.7357;Float;False;0;FLOAT;0.0;False;1;FLOAT;0.5;False;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;57;672.0042,210.9364;Float;False;Property;_gradientColor;gradientColor;9;0;0,0,0,0;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
