...
public class FracturedObjectEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(fracturedComponent.GUIExpandMain)
        {
            ...
            PropChunkHorizontalRadiusSupportStrength.floatValue = EditorGUILayout.FloatField (new GUIContent("Support Hor. Strength",     "Controls the maximum horizontal pullDistance a chunk must be from a support chunk to stay attached to the object. If its pullDistance is greater than this value, it will fall."), PropChunkHorizontalRadiusSupportStrength.floatValue);
        ...
        if(fracturedComponent.GUIExpandEvents)
        {
            ...
            EditorGUILayout.PropertyField(PropEventDetachUpwardsModifier,               new GUIContent("Upwards Modifier",       "Adds an upwards explosion effect to the chunks that have exit force. A value of 0.0 won't add any effect, while 2.0 means it will apply the force from a pullDistance of 2 below the chunk."));
