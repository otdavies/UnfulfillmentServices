...
{
	[Serializable]
	[NodeAttributes( "Texture Array", "Textures", "Texture Array", KeyCode.None, true, 0, typeof( Texture2DArray ) )]
	public class TextureArrayNode : PropertyNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			{
				if ( isVertex )
					uvs = TexCoordVertexDataNode.GenerateVertexUVs( ref dataCollector, m_uniqueId, m_uvSet, ( instanced ? m_referenceSampler.PropertyName : PropertyName ) );
				else
			...
			//{
			RegisterLocalVariable( 0, result, ref dataCollector, "texArray" + m_uniqueId );
			//dataCollector.AddToLocalVariables( m_uniqueId, "float" + ( m_autoUnpackNormals ? "3" : "4" ) + " texArray" + m_uniqueId + " = " + result + ";" );
			return GetOutputVectorItem( 0, outputId, m_outputPorts[ 0 ].LocalValue );
			//}
			//else
			//{
