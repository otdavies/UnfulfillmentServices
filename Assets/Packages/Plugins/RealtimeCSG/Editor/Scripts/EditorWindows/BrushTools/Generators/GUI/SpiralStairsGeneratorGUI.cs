...
{
	internal static class SpiralStairsGeneratorGUI
	{
		...
		static void OnGUIContents(SpiralStairsGenerator generator, bool isSceneGUI)
		{	
			GUILayout.BeginVertical(GUIStyleUtility.ContentEmpty);
			{
				...
				EditorGUI.BeginChangeCheck();
				var stepDepth		= Mathf.Max(FloatUnitsSettings(generator.StepDepth,	StepDepthContent,		StepDepthTooltip,		isSceneGUI), SpiralStairsSettings.kMinStepDepth);
				if (EditorGUI.EndChangeCheck()) { generator.StepDepth = stepDepth; }

				EditorGUI.BeginChangeCheck();
				var stepHeight	= Mathf.Max(FloatUnitsSettings(generator.StepHeight,	StepHeightContent,		StepHeightTooltip,		isSceneGUI), SpiralStairsSettings.kMinStepHeight);
		...
		public static bool OnShowGUI(SpiralStairsGenerator generator, bool isSceneGUI)
		{
