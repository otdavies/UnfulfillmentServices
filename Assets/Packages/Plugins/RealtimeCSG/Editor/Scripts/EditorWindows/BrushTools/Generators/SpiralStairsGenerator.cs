...
{
	[Serializable]
    internal sealed class SpiralStairsGenerator : GeneratorBase, IBrushGenerator
	{
		...
		[SerializeField] SpiralStairsSettings settings = new SpiralStairsSettings();
		...
		public bool OnShowGUI(bool isSceneGUI) { return SpiralStairsGeneratorGUI.OnShowGUI(this, isSceneGUI);	}
