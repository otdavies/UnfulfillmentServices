	...
	public sealed class TangentVertexDataNode : VertexDataNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalVar )
		{
			...
			else
			{
				...
				GeneratorUtils.GenerateWorldTangent( ref dataCollector, m_uniqueId );
				...
				dataCollector.AddToLocalVariables( m_uniqueId, m_currentPrecisionType, WirePortDataType.FLOAT3, "vertexTangent", "mul( " + matrix + ", float4( "+ GeneratorUtils.WorldTangentStr + ", 0 ) )" );
