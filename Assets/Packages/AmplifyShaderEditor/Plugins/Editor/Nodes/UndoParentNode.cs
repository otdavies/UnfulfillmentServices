...
namespace AmplifyShaderEditor
{
	...
	public class UndoParentNode : ScriptableObject
	{
		...
		public string EditorGUITextField( Rect position, string label, string text, [DefaultValue( "EditorStyles.textField" )] GUIStyle style )
		{
		...
		public int EditorGUIIntField( Rect position, string label, int value, [DefaultValue( "EditorStyles.numberField" )] GUIStyle style )
		{
		...
		public float EditorGUIFloatField( Rect position, string label, float value, [DefaultValue( "EditorStyles.numberField" )] GUIStyle style )
		{
		...
		public float EditorGUIFloatField( Rect position, float value, [DefaultValue( "EditorStyles.numberField" )] GUIStyle style )
		{
		...
		public Enum EditorGUIEnumPopup( Rect position, Enum selected, [DefaultValue( "EditorStyles.popup" )] GUIStyle style )
		{
		...
		public int EditorGUIIntPopup( Rect position, int selectedValue, string[] displayedOptions, int[] optionValues, [DefaultValue( "EditorStyles.popup" )] GUIStyle style )
		{
